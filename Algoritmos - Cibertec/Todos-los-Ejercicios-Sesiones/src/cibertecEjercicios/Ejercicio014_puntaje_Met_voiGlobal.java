...
public class Ejercicio014_puntaje_Met_voiGlobal extends JFrame implements ActionListener {
	...
	public Ejercicio014_puntaje_Met_voiGlobal() {
		...
		// texto a mostrar
		lblTardanza = new JLabel("Minutos de tardanza");
		lblTardanza.setBounds(10, 13, 130, 14);
...
//PROCESA LA PULSACION DE PROOCESAR
	// AQUI VAN LOS NOMBRES DE LOS METODOS QUE SE EJECUTARAN AL PRECIONAR EL BOTON
	// PROCESAR
...
//METODO BORRAR		
	...
	void ingresarDatos() {
		...
		NObse = Integer.parseInt(txtObservaciones.getText());
	}
