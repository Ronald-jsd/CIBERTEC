...
public class Ejercicio040_DadoyContador extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		// Diseñe un programa que lance tres dados aleatoriamente hasta obtener 6 en los
		// tres dados.
		// Imprima los puntajes obtenidos en cada dado y la cantidad de lanzamientos
		// efectuados.
