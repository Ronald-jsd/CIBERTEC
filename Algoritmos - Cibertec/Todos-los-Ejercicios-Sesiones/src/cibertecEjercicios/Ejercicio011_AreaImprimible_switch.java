...
class Ejercicio011_AreaImprimible_switch extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Ejercicio011_AreaImprimible_switch frame = new Ejercicio011_AreaImprimible_switch();
	...
	public Ejercicio011_AreaImprimible_switch() {
		setTitle("Area Imprimible");
		setBounds(150, 300, 450, 339);
		...
		cboDimensiones.setModel(new DefaultComboBoxModel<String>(
		...
		txtMsuperior = new JTextField();
		txtMsuperior.setBounds(90, 33, 80, 18);
		getContentPane().add(txtMsuperior);
		txtMsuperior.setColumns(10);
