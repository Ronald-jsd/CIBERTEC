...
public class ejercicio027 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		while (termino <= 13) {
			...
			// dentro de la variable sumaR vas a acumular las cantidades de la variable
			// termino
			// en este caso sumas la cantidad de termino = 7 y lo acumulas 7 en la variable
			// sumaR
			sumaR += termino;
		 ...
		 * 
		 * do { txtS.append(ter + "\n"); sumaResultado += ter; ter ++; } while(ter <=
		 * 100); txtS.append("Suma: " + sumaResultado);
		 */
