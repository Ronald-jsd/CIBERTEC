...
//A Ese JFrame extiende la clase ACTIONLISTENER , esta clase va captar acciones	
	...
	public static void main(String[] args) { // El metodo main es el metodo que ejecuta la aplicacion
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					Ejercicio001_Cilindro frame = new Ejercicio001_Cilindro();
	...
	public Ejercicio001_Cilindro() {
		...
		txtRadio = new JTextField(); // nuevo objeto de la clase JTextField, lo que esta entre parentesis va depender
										// de lo que ingresa el usuario
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		// ENTRADA DE DATOS
		r = Double.parseDouble(txtRadio.getText()); // Todo valor ingresado por jtextfield entra como texto, por lo que
													// debemos parsear
		// pasedouble va convertir a decimal lo que esta dentro del txt radio, que esta
		// en el jtextFiel
